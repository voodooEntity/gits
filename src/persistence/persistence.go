...
func Init() chan types.PersistencePayload {
	...
	// lets created the persistence channel & flag
	PersistenceFlag = true
	PersistenceChan = make(chan types.PersistencePayload, 100000)
	// and add the temporary channel for import
	importChan := make(chan types.PersistencePayload, 1000000)
...
// - - - - - - - - - - - - - - - - - - - - - - - - - -
// Handle entity
func handleEntity(payload types.PersistencePayload) error {
	var err error
	// dispatch the action
...
// - - - - - - - - - - - - - - - - - - - - - - - - - -
// Handle relation
func handleRelation(payload types.PersistencePayload) error {
	var err error
	// dispatch the action
	switch payload.Method {
	case "Create":
...
// - - - - - - - - - - - - - - - - - - - - - - - - - -
// import the entities
func importEntities(importChan chan types.PersistencePayload) {
	// predefinitions
...
// - - - - - - - - - - - - - - - - - - - - - - - - - -
// import the relation
func importRelations(importChan chan types.PersistencePayload) {
	// predefinitions
